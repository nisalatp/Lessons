    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style='background-color:yellow'>
                ...
                <button type="button" class="btn-close" data-bs-dismiss="modal" style='color:red !important' aria-label="Close"></button>
            </div>
            <form action="/app/functions/userRegister.function.php" method="post">
